package com.house.fr.application.config;
...
@Configuration
@EnableMongoRepositories("com.house.fr.application.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.house.fr.application.config.dbmigrations");
